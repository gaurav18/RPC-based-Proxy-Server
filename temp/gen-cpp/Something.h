...
class SomethingIf {
 public:
  virtual ~SomethingIf() {}
  virtual void ping(std::string& _return, const std::string& s) = 0;
};
...
typedef struct _Something_ping_args__isset {
  _Something_ping_args__isset() : s(false) {}
  bool s;
...
class SomethingClient : virtual public SomethingIf {
 public:
  ...
  void ping(std::string& _return, const std::string& s);
  void send_ping(const std::string& s);
